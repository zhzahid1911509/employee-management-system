...
const Footer = () => {
    return (
        <div className="">
           <footer className="flex justify-center md:justify-between items-center flex-wrap p-4 bg-sky-600 text-neutral-content ">
  <aside className="flex flex-col items-center md:flex-row gap-2">
  ...
  <nav className="flex justify-center items-center gap-3 my-4">
